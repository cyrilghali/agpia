  ...
  "1": {
    ...
    blocks: [
      ...
      },
      {
        ...
        content: [
          [
            "Rendons grâce à Dieu bienfaiteur et miséricordieux,",
            "Père de notre Seigneur, Dieu et Sauveur",
            "Jésus-Christ parce qu'il nous a protégés, aidés, conservés,",
            "reçus avec bonté, traités avec miséricorde,",
            "fortifiés et fait parvenir jusqu'à cette heure."
          ],
          [
            "Supplions-le encore de nous garder en ce saint jour",
            "et tous les jours de notre vie en toute paix ;",
            "Lui qui est tout puissant, le Seigneur notre Dieu."
          ],
          [
            "O Maître Seigneur, Dieu tout-puissant, Père de notre",
            "Seigneur, Dieu et Sauveur Jésus-Christ, nous te",
            "rendons grâce, de toute chose, pour toute chose et",
            "en toute chose, parce que tu nous as protégés,",
            "aidés, conservés, reçus avec bonté, traités avec",
            "miséricorde, fortifiés et fait parvenir jusqu'à cette",
            "heure."
          ],
          [
            "Pour cela, nous implorons Ta bonté, ô Ami du genre",
            "humain, donne-nous d'achever ce saint jour et tous",
            "les jours de notre vie en toute paix dans Ta crainte.",
            "Toute envie, toute tentation, toute œuvre de satan,",
            "toute intrigue des hommes méchants, toute attaque",
            "des ennemis visibles et invisibles : éloigne-les de",
            "nous et de tout ton peuple et de ce lieu saint qui est",
            "à Toi."
          ],
          [
            "Comble-nous de tous les biens et de tous les",
            "dons convenables car c'est Toi qui nous as donné le",
            "pouvoir de fouler aux pieds les serpents, les scorpions",
            "et toute la puissance de l'ennemi.",
            "Ne nous induis pas en tentation mais délivre-nous du",
            "malin. Par la grâce, la miséricorde et l'amour du",
            "genre humain de Ton Fils unique notre Seigneur,",
            "Dieu et Sauveur Jésus-Christ par Qui la gloire, l'honneur,",
            "la magnificence et l'adoration Te sont dûs avec",
            "Lui et le Saint-Esprit vivifiant et consubstantiel à Toi,",
      ...
      },
      {
        id: "h1-gospel",
        type: "gospel",
        title: "Évangile selon saint Jean (1:1-17)",
        content: [
          [
      ...
      },
      {
        ...
        content: [
          [
            ...
            "et nous as fait parvenir au début de ce jour."
          ],
          [
            "Nous Te supplions notre maître, Roi de tout",
            "temps, que la lumière de Ta Face et de Ta Connaissance divine",
          ...
          [
            ...
            "mal, de tout péché et de toute force de l'ennemi."
          ],
          [
            "Par",
      ...
      },
      {
        id: "h1-conclusion",
        type: "conclusion",
        title: "Conclusion de chaque heure",
        content: [
          [
          ...
          [
            "Ainsi nous arriverons à l'unité de",
  ...
  "3": {
    ...
    blocks: [
      ...
      },
      {
        id: "h3-gospel",
        type: "gospel",
        title: "Évangile selon saint Jean (14:26-15:4)",
        content: [
          [
      ...
      },
      {
        ...
        content: [
          [
            "Ton Esprit-Saint Seigneur, que tu as répandu sur tes",
      ...
      },
      {
        id: "h3-absolution",
        type: "absolution",
        title: "Absolution de la prière de la 3ème heure",
        content: [
          [
            ...
            "nous as relevés pour prier en cette heure sainte où Tu",
          ...
          [
            "Nous T'invoquons et Te supplions ô Ami du genre humain,",
  ...
  "6": {
    ...
    blocks: [
      ...
      },
      {
        id: "h6-gospel",
        type: "gospel",
        title: "Évangile selon saint Matthieu (5:1-16)",
        content: [
          [
      ...
      },
      {
        ...
        content: [
          [
            "Ô Toi qui au 6ème jour à la 6ème heure a été cloué sur",
          ...
          [
            ...
            "Croix à la 6ème heure, Tu as éliminé le péché par",
      ...
      },
      {
        id: "h6-absolution",
        type: "absolution",
        title: "Absolution de la prière de la 6ème heure",
        content: [
          [
          ...
          [
            ...
            "as vaincu toute la puissance de l'ennemi."
          ],
          [
            "Accorde-",
          ...
          [
            "Fais que nous puissions Te glorifier",
    ...
    blocks: [
      ...
      },
      {
        ...
        content: [
          ...
          [
            "Jésus dit à ses disciples : Faites les asseoir par",
      ...
      },
      {
        ...
        content: [
          [
            "Toi qui à la 9ème heure a goûté la mort corporelle",
          ...
          [
            ...
            "Tu as été crucifié à la 9ème heure et qui as conduit le",
      ...
      },
      {
        id: "h9-absolution",
        type: "absolution",
        title: "Absolution de la prière de la 9ème heure",
        content: [
          [
          ...
          [
            "Ainsi, après avoir quitté ce corps, nous",
  ...
  "11": {
    ...
    blocks: [
      ...
      },
      {
        id: "h11-gospel",
        type: "gospel",
        title: "Évangile selon saint Luc (4:38-41)",
        content: [
          [
      ...
      },
      {
        id: "h11-absolution",
        type: "absolution",
        title: "Absolution de la prière de la onzième heure",
        content: [
          [
          ...
          [
            "Fais que nous la traversions dans la",
  ...
  "12": {
    ...
    blocks: [
      ...
      },
      {
        id: "h12-gospel",
        type: "gospel",
        title: "Évangile selon saint Luc (2:25-32)",
        content: [
          [
      ...
      },
      {
        id: "h12-absolution",
        type: "absolution",
        title: "Absolution de la prière de la douzième heure",
        content: [
          [
          ...
          [
            "Par la grâce, la compassion et l'amour du",
            "genre humain de Ton Fils unique notre Seigneur,",
...
// Centralized state ensures only one hour and one block stay active at a time.
const state = {
  selectedHourKey: "1",
  activeBlockIndex: 0,
  lastPositions: {}
...
function renderHourButtons() {
  return Object.entries(HOURS)
    .map(([key, hour]) => {
      ...
      return `<button class="hour-button ${isActive}" type="button" data-hour="${key}">${hour.title}</button>`;
    })
    .join("");
}
...
function bindHourButtonEvents() {
  const buttons = appRoot.querySelectorAll(".hour-button");
  buttons.forEach((button) => {
    button.addEventListener("click", () => selectHour(button.dataset.hour));
  });
}
...
function selectHour(hourKey) {
  if (!HOURS[hourKey]) return;
  if (hourKey === state.selectedHourKey) return;
